import './App.css'
import {User , LockKeyhole, Facebook, PersonStanding, ArrowRight, ListTodo, Twitter, Youtube, Instagram, Github, Check} from "lucide-react"
  ...
  return (
    <>
      <body className="bg-[#F1F3FE] relative">
        ...
        {/* Cabeçalho */}
        <header className="pt-8 px-56 ">

          <div className="container mx-auto flex justify-between items-center">
            <div className='py-3 flex items-center'>
              <h1 className="text-4xl relative font-bold after:content-[''] after:block after:w-[85px] after:h-[2px] after:bg-black after:ml-auto">
                Organotes
              </h1>
              <img src="/logo.png" alt="Logo" className="mt-1 h-8" />
            </div>


            <div>
              <div className="flex text-2xl gap-25">
                <a href="#" className="relative group inline-block p-2">
                  <h1 className="relative z-10 text-black">Planos</h1>

                  <span className="absolute inset-0 border-2 border-transparent rounded-xl 
                                  transition-all duration-500 ease-in-out 
                                  group-hover:border-[#979ACB] group-hover:border-t-2 group-hover:border-b-2
                                  group-hover:border-l-2 group-hover:border-r-2"></span>
                </a>
                ...
                <div className="relative bg-[#F1F3FE] rounded-3xl border-2 border-[#979ACB] px-3 group hover:border-[#434561] transition-all duration-300 ease-in-out">
                  <a href="#" className="relative inline-block p-2">
        ...
        {/* Parte de Login */}
        <nav className="px-56 mt-[200px] mx-auto flex justify-between">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-row justify-between">
              ...
              <a href="#" className="text-[#F1F3FE] hover:text-[#434561] transition delay-30">
          ...
          <div className="w-[400px] bg-[#434561C7] opacity-85 relative left-[-150px] top-[-20px] rounded-2xl">

            <h1 className="text-3xl text-black px-7 pt-6 mb-23 relative after:content-[''] after:block after:w-[70px] after:h-[2px] after:bg-black">Inscreva-se</h1>
            ...
            <div className="flex flex-col gap-7 px-12">
              ...
              <a href="#" className="text-[#FFFFFF] hover:text-[#434561] transition delay-30 flex justify-center items-center">
                <div className="rounded-2xl px-15 py-2 bg-[#434561] hover:bg-[#F1F3FE] 
        ...
        <div className="bg-[#979ACB] h-[180px] mt-36 flex justify-center items-center gap-40 mb-5">

          <div className="text-[#FFFFFF]">
            <div className="text-6xl flex items-center justify-start font-bold">
              <h1 className="">+</h1>
          ...
          <div className="text-[#FFFFFF]">
            <div className="flex justify-start">
              ...
              <div className="flex flex-col">
                <h1 className="ml-2 text-6xl font-bold">50</h1> 
          ...
          <div className="text-[#FFFFFF]">
            <div className="text-6xl flex items-center justify-center font-bold">
              <h1 className="">40</h1>
        ...
        {/* Funções - OrgaNotes */}
        <div className="flex px-56 gap-20 mb-25">
          ...
          <div className="flex flex-col mt-25 gap-4 items-center">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-2xl">Estude com as melhores ferramentas</p>
              <p className="text-2xl">e alcance seu máximo potencial.</p>
          ...
          <div className="flex gap-12 items-start">
            ...
            <div className="flex flex-col items-center gap-5 py-10 bg-[#979ACB] text-[#FFF] rounded-2xl px-5 mt-40 w-[270px] shadow-2xl">
              ...
              In tincidunt donec tellus egestas eget massa. 
              Malesuada id felis nibh justo ultricies faucibus quis ornare lectus.
              </p>
        ...
        <div className="px-56 flex gap-70 mb-20">

          <div className="ml-10 relative">
            <img src='/Desktop.png' alt='imagem' className="w-full h-auto"/>

            <img src='/Frame.png' alt='imagem' 
          ...
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            <div className="flex flex-col gap-1 justify-center">
              ...
              <p className="text-2xl">experiência perfeita no desktop e mobile.</p>
        ...
        <div className="h-[1025px] bg-[#898EC7] relative flex justify-center items-center">
          ...
          <div className="absolute flex justify-center items-center gap-10">

            <img src="/calendario.png" alt="Calendário" className="w-[650px] h-auto relative -left-20"/>
          ...
          <div className='flex gap-20 mt-40 mb-30 justify-center items-start'>
            ...
            <div className='bg-[#CACCE5] h-[540px] w-[350px] relative flex flex-col rounded-3xl px-10 py-15 gap-6 shadow-lg'>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className='flex gap-2'>
                  ...
                  <p className='text-[#FFF]'>Organização de matérias e tarefas</p>
                </div>

                <div className='flex gap-2'>
                  <Check className="text-[#434561]"/>
                  <p className='text-[#FFF]'>Lembretes e notificações básicas</p>
                </div>
            ...
            <img 
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className='flex gap-2'>
                  <Check className="text-[#434561]"/>
                  <p className='text-[#FFF]'>Relatórios de desempenho 
                  acadêmico</p>
                </div>
        ...
        <footer className="bg-[#434561] h-[300px] px-25 py-10">
          ...
          <div className="flex justify-between mb-12">
            ...
            <div className="flex gap-40 text-lg mr-20">
              ...
              <div className="flex flex-col">
                ...
                <div className="text-[#FFF] flex flex-col gap-1">
                  <a href="#" className="relative transition duration-300 ease-in-out after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-[#FFF] after:transition-all after:duration-300 hover:after:w-full hover:after:left-0">
                    Início
                  </a>
          ...
          <div className="flex justify-between">
            ...
            <p className="text-[#FFF]">Todos os direitos reservados. Copyright © 2023</p>
